test_that("mesh_parents and mesh_ancestors traverse relationships", {
  ...
  expect_setequal(children$child_id, c("D000002", "D000003", "D000004", "D000005"))
  expect_equal(
    children$distance[match(c("D000002", "D000003", "D000004", "D000005"), children$child_id)],
    c(1L, 1L, 2L, 2L)
  )
  ...
  expect_equal(
    ancestors$distance[match(c("D000001", "D000002", "D000003"), ancestors$ancestor_id)],
    c(2L, 1L, 1L)
  )
})
...
test_that("mesh_common_parents identifies shared direct and ancestor parents", {
  ...
  direct <- mesh_common_parents(c("Child A", "Child B"), relationship = "parent", db = db)
  expect_equal(direct$common_parent_id, "D000002")

  ancestors <- mesh_common_parents(c("Child A", "Child B"), relationship = "ancestor", db = db)
...
test_that("mesh_is_child identifies descendants and distance to parent", {
  ...
  out <- mesh_is_child(c("D000004", "D000005", "D000001", "D999999"), "Parent A", db = db)
